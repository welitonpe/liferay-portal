...
<%
LLMSCompanyConfigurationDisplayContext llmsCompanyConfigurationDisplayContext = (LLMSCompanyConfigurationDisplayContext)request.getAttribute(LLMSCompanyConfigurationDisplayContext.class.getName());
%>
...
>
	...
	>
		...
		>
			<clay:checkbox
				checked="<%= llmsCompanyConfigurationDisplayContext.isEnabled() %>"
	...
	>
		...
		>
			...
			<aui:input aria-label='<%= LanguageUtil.get(request, "llms-txt-content") %>' label="" name="content" type="textarea" value="<%= llmsCompanyConfigurationDisplayContext.getContent() %>" />
		</clay:content-col>
	</clay:content-row>
</clay:sheet-section>