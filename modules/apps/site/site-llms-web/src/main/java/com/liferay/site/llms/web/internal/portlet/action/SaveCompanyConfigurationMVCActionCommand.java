...
package com.liferay.site.llms.web.internal.portlet.action;
...
@Component(
	property = {
		...
		"mvc.command.name=/site_llms/save_company_configuration"
	},
...
public class SaveCompanyConfigurationMVCActionCommand
	...
	protected void doProcessAction(
		...
		_llmsConfigurationManager.saveLLMSCompanyConfiguration(
			themeDisplay.getCompanyId(),
			ParamUtil.getBoolean(actionRequest, "enabled"),
			ParamUtil.getString(actionRequest, "content"));
