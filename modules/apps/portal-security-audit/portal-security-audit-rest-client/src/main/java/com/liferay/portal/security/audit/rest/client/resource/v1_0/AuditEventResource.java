...
public interface AuditEventResource {
	...
	public Page<AuditEvent> getAuditEventsPage(
			Long[] accountIds, String contextName, java.util.Date endDate,
			String eventType, java.util.Date startDate, Pagination pagination,
			String sortString)
		throws Exception;
		...
		public Page<AuditEvent> getAuditEventsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getAuditEventsPageHttpResponse(
					accountIds, contextName, endDate, eventType, startDate,
...
// LIFERAY-REST-BUILDER-HASH:1996593512